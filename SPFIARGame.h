...
* @param src - source game
* @return
* true iff the game is in a tie state
*/
bool checkTie(SPFiarGame* src);

/**
* Helper routine for scanning functions that updates sequence counter and symbol according
* to the current symbol on the board.
* @param boardSymbol - current symbol being scanned
...
/**
* Scan columns for a sequence of 4 of the same player symbol.
* @param src - source game
* @return
* SP_FIAR_GAME_PLAYER_1_SYMBOL - if player 1 won
* SP_FIAR_GAME_PLAYER_2_SYMBOL - if player 2 won
...
/**
* Scan downward diagonals for a sequence of 4 of the same player symbol.
* @param src - source game
* @return
* SP_FIAR_GAME_PLAYER_1_SYMBOL - if player 1 won
* SP_FIAR_GAME_PLAYER_2_SYMBOL - if player 2 won
...
/**
* Auxiliary function for scanDownwardDiag.
* Scan downward diagonals under the max length diagonals for a sequence
* of 4 of the same player symbol.
* @param src - source game
* @return
* SP_FIAR_GAME_PLAYER_1_SYMBOL - if player 1 won
* SP_FIAR_GAME_PLAYER_2_SYMBOL - if player 2 won
...
/**
* Auxiliary function for scanDownwardDiag.
* Scan downward diagonals with max length for a sequence
* of 4 of the same player symbol.
* @param src - source game
* @return
* SP_FIAR_GAME_PLAYER_1_SYMBOL - if player 1 won
...
/**
* Auxiliary function for scanDownwardDiag.
* Scan downward diagonals above the max length diagonals for a sequence
* of 4 of the same player symbol.
* @param src - source game
* @return
* SP_FIAR_GAME_PLAYER_1_SYMBOL - if player 1 won
...
/**
* Scan upward diagonals for a sequence of 4 of the same player symbol.
* @param src - source game
* @return
* SP_FIAR_GAME_PLAYER_1_SYMBOL - if player 1 won
* SP_FIAR_GAME_PLAYER_2_SYMBOL - if player 2 won
...
/**
* Auxiliary function for scanUpwardDiag.
* Scan upward diagonals above the max length diagonals for a sequence
* of 4 of the same player symbol.
* @param src - source game
* @return
* SP_FIAR_GAME_PLAYER_1_SYMBOL - if player 1 won
...
/**
* Auxiliary function for scanUpwardDiag.
* Scan upward diagonals with max length for a sequence
* of 4 of the same player symbol.
* @param src - source game
* @return
* SP_FIAR_GAME_PLAYER_1_SYMBOL - if player 1 won
...
/**
* Auxiliary function for scanUpwardDiag.
* Scan upward diagonals under the max length diagonals for a sequence
* of 4 of the same player symbol.
* @param src - source game
* @return
* SP_FIAR_GAME_PLAYER_1_SYMBOL - if player 1 won
